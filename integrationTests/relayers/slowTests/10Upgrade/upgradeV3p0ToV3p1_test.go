...
func step2DoSwapsOnV3p1(flows []*slowTests.TestFlow) {
...

	{
		...
		startsFromEthFlow.Tokens[0].MintBurnChecks.MvxTotalUniversalMint = big.NewInt(2 * (5000 + 7000))
		startsFromEthFlow.Tokens[0].MintBurnChecks.MvxTotalChainSpecificMint = big.NewInt(2 * (5000 + 7000))
		...
		startsFromEthFlow.Tokens[0].MintBurnChecks.MvxSafeMintValue = big.NewInt(2 * (5000 + 7000))
		startsFromEthFlow.Tokens[0].MintBurnChecks.MvxSafeBurnValue = big.NewInt(2 * (2500 - 50 + 300 - 50))

		startsFromEthFlow.Tokens[0].SpecialChecks.WrapperDeltaLiquidityCheck = big.NewInt(2 * (5000 + 7000 - 2500 - 300))
	}
