...
func (keyStore *KeysStore) getAllKeys() []KeysHolder {
	...
	allKeys = append(allKeys, keyStore.SCExecutorKeys, keyStore.OwnerKeys, keyStore.DepositorKeys, keyStore.TestKeys, keyStore.AliceKeys, keyStore.BobKeys, keyStore.CharlieKeys)
