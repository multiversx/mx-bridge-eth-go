...
//
// Solidity: function initSupplyMintBurn(address tokenAddress, uint256 mintAmount, uint256 burnAmount) returns()
func (_ERC20Safe *ERC20SafeTransactor) InitSupplyMintBurn(opts *bind.TransactOpts, tokenAddress common.Address, mintAmount *big.Int, burnAmount *big.Int) (*types.Transaction, error) {
	return _ERC20Safe.contract.Transact(opts, "initSupplyMintBurn", tokenAddress, mintAmount, burnAmount)
}

// InitSupplyMintBurn is a paid mutator transaction binding the contract method 0xe9935b4a.
//
// Solidity: function initSupplyMintBurn(address tokenAddress, uint256 mintAmount, uint256 burnAmount) returns()
func (_ERC20Safe *ERC20SafeSession) InitSupplyMintBurn(tokenAddress common.Address, mintAmount *big.Int, burnAmount *big.Int) (*types.Transaction, error) {
	return _ERC20Safe.Contract.InitSupplyMintBurn(&_ERC20Safe.TransactOpts, tokenAddress, mintAmount, burnAmount)
}

// InitSupplyMintBurn is a paid mutator transaction binding the contract method 0xe9935b4a.
//
// Solidity: function initSupplyMintBurn(address tokenAddress, uint256 mintAmount, uint256 burnAmount) returns()
func (_ERC20Safe *ERC20SafeTransactorSession) InitSupplyMintBurn(tokenAddress common.Address, mintAmount *big.Int, burnAmount *big.Int) (*types.Transaction, error) {
	return _ERC20Safe.Contract.InitSupplyMintBurn(&_ERC20Safe.TransactOpts, tokenAddress, mintAmount, burnAmount)
}
...
// WhitelistToken is a paid mutator transaction binding the contract method 0x41220439.
//
// Solidity: function whitelistToken(address token, uint256 minimumAmount, uint256 maximumAmount, bool mintBurn, bool native, uint256 totalBalance, uint256 mintBalance, uint256 burnBalance) returns()
func (_ERC20Safe *ERC20SafeTransactor) WhitelistToken(opts *bind.TransactOpts, token common.Address, minimumAmount *big.Int, maximumAmount *big.Int, mintBurn bool, native bool, totalBalance *big.Int, mintBalance *big.Int, burnBalance *big.Int) (*types.Transaction, error) {
	return _ERC20Safe.contract.Transact(opts, "whitelistToken", token, minimumAmount, maximumAmount, mintBurn, native, totalBalance, mintBalance, burnBalance)
}

// WhitelistToken is a paid mutator transaction binding the contract method 0x41220439.
//
// Solidity: function whitelistToken(address token, uint256 minimumAmount, uint256 maximumAmount, bool mintBurn, bool native, uint256 totalBalance, uint256 mintBalance, uint256 burnBalance) returns()
func (_ERC20Safe *ERC20SafeSession) WhitelistToken(token common.Address, minimumAmount *big.Int, maximumAmount *big.Int, mintBurn bool, native bool, totalBalance *big.Int, mintBalance *big.Int, burnBalance *big.Int) (*types.Transaction, error) {
	return _ERC20Safe.Contract.WhitelistToken(&_ERC20Safe.TransactOpts, token, minimumAmount, maximumAmount, mintBurn, native, totalBalance, mintBalance, burnBalance)
}

// WhitelistToken is a paid mutator transaction binding the contract method 0x41220439.
//
// Solidity: function whitelistToken(address token, uint256 minimumAmount, uint256 maximumAmount, bool mintBurn, bool native, uint256 totalBalance, uint256 mintBalance, uint256 burnBalance) returns()
func (_ERC20Safe *ERC20SafeTransactorSession) WhitelistToken(token common.Address, minimumAmount *big.Int, maximumAmount *big.Int, mintBurn bool, native bool, totalBalance *big.Int, mintBalance *big.Int, burnBalance *big.Int) (*types.Transaction, error) {
	return _ERC20Safe.Contract.WhitelistToken(&_ERC20Safe.TransactOpts, token, minimumAmount, maximumAmount, mintBurn, native, totalBalance, mintBalance, burnBalance)
}
