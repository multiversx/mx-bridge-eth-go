...
// MvxTransaction is an auto generated low-level Go binding around an user-defined struct.
type MvxTransaction struct {
...
func (_Bridge *BridgeCaller) GetBatch(opts *bind.CallOpts, batchNonce *big.Int) (Batch, bool, error) {
	var out []interface{}
...
//
// Solidity: function getBatch(uint256 batchNonce) view returns((uint112,uint64,uint64,uint16), bool isBatchFinal)
func (_Bridge *BridgeSession) GetBatch(batchNonce *big.Int) (Batch, bool, error) {
...
//
// Solidity: function getBatch(uint256 batchNonce) view returns((uint112,uint64,uint64,uint16), bool isBatchFinal)
func (_Bridge *BridgeCallerSession) GetBatch(batchNonce *big.Int) (Batch, bool, error) {
	return _Bridge.Contract.GetBatch(&_Bridge.CallOpts, batchNonce)
}

// GetBatchDeposits is a free data retrieval call binding the contract method 0x90924da7.
//
// Solidity: function getBatchDeposits(uint256 batchNonce) view returns((uint112,address,uint256,address,bytes32,uint8)[], bool areDepositsFinal)
func (_Bridge *BridgeCaller) GetBatchDeposits(opts *bind.CallOpts, batchNonce *big.Int) ([]Deposit, bool, error) {
	var out []interface{}
...
//
// Solidity: function getBatchDeposits(uint256 batchNonce) view returns((uint112,address,uint256,address,bytes32,uint8)[], bool areDepositsFinal)
func (_Bridge *BridgeSession) GetBatchDeposits(batchNonce *big.Int) ([]Deposit, bool, error) {
...
//
// Solidity: function getBatchDeposits(uint256 batchNonce) view returns((uint112,address,uint256,address,bytes32,uint8)[], bool areDepositsFinal)
func (_Bridge *BridgeCallerSession) GetBatchDeposits(batchNonce *big.Int) ([]Deposit, bool, error) {
	return _Bridge.Contract.GetBatchDeposits(&_Bridge.CallOpts, batchNonce)
}
...
// ExecuteTransfer is a paid mutator transaction binding the contract method 0xe808bbb3.
//
// Solidity: function executeTransfer((address,bytes32,address,uint256,uint256,bytes)[] mvxTransactions, uint256 batchNonceMvx, bytes[] signatures) returns()
func (_Bridge *BridgeTransactor) ExecuteTransfer(opts *bind.TransactOpts, mvxTransactions []MvxTransaction, batchNonceMvx *big.Int, signatures [][]byte) (*types.Transaction, error) {
	return _Bridge.contract.Transact(opts, "executeTransfer", mvxTransactions, batchNonceMvx, signatures)
}

// ExecuteTransfer is a paid mutator transaction binding the contract method 0xe808bbb3.
//
// Solidity: function executeTransfer((address,bytes32,address,uint256,uint256,bytes)[] mvxTransactions, uint256 batchNonceMvx, bytes[] signatures) returns()
func (_Bridge *BridgeSession) ExecuteTransfer(mvxTransactions []MvxTransaction, batchNonceMvx *big.Int, signatures [][]byte) (*types.Transaction, error) {
	return _Bridge.Contract.ExecuteTransfer(&_Bridge.TransactOpts, mvxTransactions, batchNonceMvx, signatures)
}

// ExecuteTransfer is a paid mutator transaction binding the contract method 0xe808bbb3.
//
// Solidity: function executeTransfer((address,bytes32,address,uint256,uint256,bytes)[] mvxTransactions, uint256 batchNonceMvx, bytes[] signatures) returns()
func (_Bridge *BridgeTransactorSession) ExecuteTransfer(mvxTransactions []MvxTransaction, batchNonceMvx *big.Int, signatures [][]byte) (*types.Transaction, error) {
	return _Bridge.Contract.ExecuteTransfer(&_Bridge.TransactOpts, mvxTransactions, batchNonceMvx, signatures)
}

// Initialize is a paid mutator transaction binding the contract method 0xc1b4a1e3.
//
// Solidity: function initialize(address[] board, uint256 initialQuorum, address erc20Safe, address _bridgeExecutor) returns()
func (_Bridge *BridgeTransactor) Initialize(opts *bind.TransactOpts, board []common.Address, initialQuorum *big.Int, erc20Safe common.Address, _bridgeExecutor common.Address) (*types.Transaction, error) {
	return _Bridge.contract.Transact(opts, "initialize", board, initialQuorum, erc20Safe, _bridgeExecutor)
}

// Initialize is a paid mutator transaction binding the contract method 0xc1b4a1e3.
//
// Solidity: function initialize(address[] board, uint256 initialQuorum, address erc20Safe, address _bridgeExecutor) returns()
func (_Bridge *BridgeSession) Initialize(board []common.Address, initialQuorum *big.Int, erc20Safe common.Address, _bridgeExecutor common.Address) (*types.Transaction, error) {
	return _Bridge.Contract.Initialize(&_Bridge.TransactOpts, board, initialQuorum, erc20Safe, _bridgeExecutor)
}

// Initialize is a paid mutator transaction binding the contract method 0xc1b4a1e3.
//
// Solidity: function initialize(address[] board, uint256 initialQuorum, address erc20Safe, address _bridgeExecutor) returns()
func (_Bridge *BridgeTransactorSession) Initialize(board []common.Address, initialQuorum *big.Int, erc20Safe common.Address, _bridgeExecutor common.Address) (*types.Transaction, error) {
	return _Bridge.Contract.Initialize(&_Bridge.TransactOpts, board, initialQuorum, erc20Safe, _bridgeExecutor)
}
...
func (_Bridge *BridgeTransactor) SetBatchSettleLimit(opts *bind.TransactOpts, newBatchSettleLimit uint8) (*types.Transaction, error) {
	return _Bridge.contract.Transact(opts, "setBatchSettleLimit", newBatchSettleLimit)
}

// SetBatchSettleLimit is a paid mutator transaction binding the contract method 0xf2e0ec48.
//
// Solidity: function setBatchSettleLimit(uint8 newBatchSettleLimit) returns()
func (_Bridge *BridgeSession) SetBatchSettleLimit(newBatchSettleLimit uint8) (*types.Transaction, error) {
	return _Bridge.Contract.SetBatchSettleLimit(&_Bridge.TransactOpts, newBatchSettleLimit)
}

// SetBatchSettleLimit is a paid mutator transaction binding the contract method 0xf2e0ec48.
//
// Solidity: function setBatchSettleLimit(uint8 newBatchSettleLimit) returns()
func (_Bridge *BridgeTransactorSession) SetBatchSettleLimit(newBatchSettleLimit uint8) (*types.Transaction, error) {
	return _Bridge.Contract.SetBatchSettleLimit(&_Bridge.TransactOpts, newBatchSettleLimit)
}
...
// BridgePauseIterator is returned from FilterPause and is used to iterate over the raw logs and unpacked data for Pause events raised by the Bridge contract.
type BridgePauseIterator struct {
	Event *BridgePause // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *BridgePauseIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *BridgePauseIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *BridgePauseIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// BridgePause represents a Pause event raised by the Bridge contract.
type BridgePause struct {
	IsPause bool
	Raw     types.Log // Blockchain specific contextual infos
}
...
func (_Bridge *BridgeFilterer) FilterPause(opts *bind.FilterOpts) (*BridgePauseIterator, error) {

	logs, sub, err := _Bridge.contract.FilterLogs(opts, "Pause")
	if err != nil {
		return nil, err
	}
	return &BridgePauseIterator{contract: _Bridge.contract, event: "Pause", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event Pause(bool isPause)
func (_Bridge *BridgeFilterer) WatchPause(opts *bind.WatchOpts, sink chan<- *BridgePause) (event.Subscription, error) {

	logs, sub, err := _Bridge.contract.WatchLogs(opts, "Pause")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(BridgePause)
				if err := _Bridge.contract.UnpackLog(event, "Pause", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Pause(bool isPause)
func (_Bridge *BridgeFilterer) ParsePause(log types.Log) (*BridgePause, error) {
	event := new(BridgePause)
	if err := _Bridge.contract.UnpackLog(event, "Pause", log); err != nil {
		return nil, err
	}
