...
//
// Solidity: function getBatch(uint256 batchNonce) view returns((uint112,uint64,uint64,uint16), bool)
...
//
// Solidity: function getBatchDeposits(uint256 batchNonce) view returns((uint112,address,uint256,address,bytes32,uint8)[], bool)
