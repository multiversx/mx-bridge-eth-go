...
// ComputeTotalAmountsFromIndex is a free data retrieval call binding the contract method 0x124368cb.
//
// Solidity: function computeTotalAmountsFromIndex(uint256 startIndex, uint256 endIndex) view returns(address[], uint256[])
func (_ERC20Safe *ERC20SafeCaller) ComputeTotalAmountsFromIndex(opts *bind.CallOpts, startIndex *big.Int, endIndex *big.Int) ([]common.Address, []*big.Int, error) {
	var out []interface{}
	err := _ERC20Safe.contract.Call(opts, &out, "computeTotalAmountsFromIndex", startIndex, endIndex)
...
//
// Solidity: function computeTotalAmountsFromIndex(uint256 startIndex, uint256 endIndex) view returns(address[], uint256[])
func (_ERC20Safe *ERC20SafeSession) ComputeTotalAmountsFromIndex(startIndex *big.Int, endIndex *big.Int) ([]common.Address, []*big.Int, error) {
	return _ERC20Safe.Contract.ComputeTotalAmountsFromIndex(&_ERC20Safe.CallOpts, startIndex, endIndex)
}

// ComputeTotalAmountsFromIndex is a free data retrieval call binding the contract method 0x124368cb.
//
// Solidity: function computeTotalAmountsFromIndex(uint256 startIndex, uint256 endIndex) view returns(address[], uint256[])
func (_ERC20Safe *ERC20SafeCallerSession) ComputeTotalAmountsFromIndex(startIndex *big.Int, endIndex *big.Int) ([]common.Address, []*big.Int, error) {
	return _ERC20Safe.Contract.ComputeTotalAmountsFromIndex(&_ERC20Safe.CallOpts, startIndex, endIndex)
}
...
// SetMintBalances is a paid mutator transaction binding the contract method 0x4c304682.
//
// Solidity: function setMintBalances(address tokenAddress, uint256 amount) returns()
func (_ERC20Safe *ERC20SafeTransactor) SetMintBalances(opts *bind.TransactOpts, tokenAddress common.Address, amount *big.Int) (*types.Transaction, error) {
	return _ERC20Safe.contract.Transact(opts, "setMintBalances", tokenAddress, amount)
}

// SetMintBalances is a paid mutator transaction binding the contract method 0x4c304682.
//
// Solidity: function setMintBalances(address tokenAddress, uint256 amount) returns()
func (_ERC20Safe *ERC20SafeSession) SetMintBalances(tokenAddress common.Address, amount *big.Int) (*types.Transaction, error) {
	return _ERC20Safe.Contract.SetMintBalances(&_ERC20Safe.TransactOpts, tokenAddress, amount)
}

// SetMintBalances is a paid mutator transaction binding the contract method 0x4c304682.
//
// Solidity: function setMintBalances(address tokenAddress, uint256 amount) returns()
func (_ERC20Safe *ERC20SafeTransactorSession) SetMintBalances(tokenAddress common.Address, amount *big.Int) (*types.Transaction, error) {
	return _ERC20Safe.Contract.SetMintBalances(&_ERC20Safe.TransactOpts, tokenAddress, amount)
}
