...
func (_ERC20Safe *ERC20SafeCaller) TokenBalances(opts *bind.CallOpts, arg0 common.Address) (*big.Int, error) {
	var out []interface{}
	err := _ERC20Safe.contract.Call(opts, &out, "tokenBalances", arg0)
...
//
// Solidity: function tokenBalances(address ) view returns(uint256)
func (_ERC20Safe *ERC20SafeSession) TokenBalances(arg0 common.Address) (*big.Int, error) {
	return _ERC20Safe.Contract.TokenBalances(&_ERC20Safe.CallOpts, arg0)
}

// TokenBalances is a free data retrieval call binding the contract method 0x523fba7f.
//
// Solidity: function tokenBalances(address ) view returns(uint256)
func (_ERC20Safe *ERC20SafeCallerSession) TokenBalances(arg0 common.Address) (*big.Int, error) {
	return _ERC20Safe.Contract.TokenBalances(&_ERC20Safe.CallOpts, arg0)
}
...
// WhitelistToken is a paid mutator transaction binding the contract method 0x1ce330ec.
//
// Solidity: function whitelistToken(address token, uint256 minimumAmount, uint256 maximumAmount) returns()
func (_ERC20Safe *ERC20SafeTransactor) WhitelistToken(opts *bind.TransactOpts, token common.Address, minimumAmount *big.Int, maximumAmount *big.Int) (*types.Transaction, error) {
	return _ERC20Safe.contract.Transact(opts, "whitelistToken", token, minimumAmount, maximumAmount)
}

// WhitelistToken is a paid mutator transaction binding the contract method 0x1ce330ec.
//
// Solidity: function whitelistToken(address token, uint256 minimumAmount, uint256 maximumAmount) returns()
func (_ERC20Safe *ERC20SafeSession) WhitelistToken(token common.Address, minimumAmount *big.Int, maximumAmount *big.Int) (*types.Transaction, error) {
	return _ERC20Safe.Contract.WhitelistToken(&_ERC20Safe.TransactOpts, token, minimumAmount, maximumAmount)
}

// WhitelistToken is a paid mutator transaction binding the contract method 0x1ce330ec.
//
// Solidity: function whitelistToken(address token, uint256 minimumAmount, uint256 maximumAmount) returns()
func (_ERC20Safe *ERC20SafeTransactorSession) WhitelistToken(token common.Address, minimumAmount *big.Int, maximumAmount *big.Int) (*types.Transaction, error) {
	return _ERC20Safe.Contract.WhitelistToken(&_ERC20Safe.TransactOpts, token, minimumAmount, maximumAmount)
}
