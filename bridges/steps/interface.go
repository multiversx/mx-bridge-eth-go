...
type Executor interface {
	...
	GetLastExecutedPeerBatchIDFromMultiversX(ctx context.Context) (uint64, error)
	...
	CheckAvailableTokens(ctx context.Context, peerTokens [][]byte, mvxTokens [][]byte, amounts []*big.Int, direction batchProcessor.Direction) error
