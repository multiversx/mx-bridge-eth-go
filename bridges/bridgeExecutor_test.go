...
func TestEthToMultiversXBridgeExecutor_GetAndStoreBatchFromPeerChain(t *testing.T) {
	t.Parallel()
...
func TestEthToMultiversXBridgeExecutor_GetLastExecutedEthBatchIDFromMultiversX(t *testing.T) {
	...
	batchID, err := executor.GetLastExecutedPeerBatchIDFromMultiversX(context.Background())
	assert.Equal(t, providedBatchID, batchID)
	assert.Nil(t, err)
	assert.True(t, setIntCalled)
}

func TestEthToMultiversXBridgeExecutor_VerifyLastDepositNonceExecutedOnPeerBatch(t *testing.T) {
	t.Parallel()
...
func TestMultiversXToEthBridgeExecutor_WasTransferPerformedOnPeerChain(t *testing.T) {
	t.Parallel()
...
func TestMultiversXToEthBridgeExecutor_SignTransferOnPeerChain(t *testing.T) {
	t.Parallel()
...
func TestMultiversXToEthBridgeExecutor_PerformTransferOnPeerChain(t *testing.T) {
	t.Parallel()
...
func TestBridgeExecutor_CheckAvailableTokens(t *testing.T) {
	...
	args.BalanceValidator = &testsCommon.BalanceValidatorStub{
		CheckTokenCalled: func(ctx context.Context, ethToken []byte, mvxToken []byte, amount *big.Int, direction batchProcessor.Direction) error {
