...
func createElrondMockArgs() ArgsElrondRoleProvider {
	return ArgsElrondRoleProvider{
		...
		ElrondChainInteractor: &interactors.ElrondChainInteractorStub{},
	}
}
...
func TestNewElrondRoleProvider(t *testing.T) {
	...
	t.Run("nil elrond chain interactor should error", func(t *testing.T) {
		args := createElrondMockArgs()
		args.ElrondChainInteractor = nil

		erp, err := NewElrondRoleProvider(args)
		assert.True(t, check.IfNil(erp))
		assert.Equal(t, ErrNilElrondChainInteractor, err)
	})
...
func TestElrondRoleProvider_ExecuteErrorsInInteractor(t *testing.T) {
	t.Parallel()

	expectedErr := errors.New("expected error")
	args := createElrondMockArgs()
	args.ElrondChainInteractor = &interactors.ElrondChainInteractorStub{
