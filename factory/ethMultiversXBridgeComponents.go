...
type ethMultiversXBridgeComponents struct {
	...
	ethToMultiversXSignaturesHolder bridges.SignaturesHolder
...
func (components *ethMultiversXBridgeComponents) createBalanceValidator() (bridges.BalanceValidator, error) {
